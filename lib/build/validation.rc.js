...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    function Base() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Base.__proto__ || Object.getPrototypeOf(Base)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (event) {
	            ...
	            _this.setState({
	                ...
	                _this.props.validateOnChange && _this.context.validateState(_this.props.name);
	            ...
	            _this.setState({
	                ...
	                _this.context.hideError(event.target.name);
	                (_this.props.onFocus || _noop2.default)(event);
	            });
	...
	Base.contextTypes = {
	    ...
	    errorsForComponent: _react.PropTypes.func.isRequired,
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            ...
	            var _props = this.props,
	                ...
	                className = _props.className,
	                validateOnChange = _props.validateOnChange,
	                rest = _objectWithoutProperties(_props, ['validations', 'errorClassName', 'containerClassName', 'errorContainerClassName', 'className', 'validateOnChange']);
	            // TODO: Refactor conditions


	            var isInvalid = this.state.isUsed && this.state.isChanged && !this.state.isFocused && !!this.context.errors[this.props.name];
	    ...
	    _createClass(Textarea, [{
	        ...
	        value: function render() {
	            ...
	            var _props = this.props,
	                ...
	                validateOnChange = _props.validateOnChange,
	                className = _props.className,
	                rest = _objectWithoutProperties(_props, ['validations', 'errorClassName', 'containerClassName', 'errorContainerClassName', 'validateOnChange', 'className']);
	            // TODO: Refactor conditions
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = function (_Component) {
	    ...
	    function Form(props) {
	        ...
	        _this.errorsForComponent = function (name) {
	            ...
	            return validations.map(function (validation) {
	                if (_rules2.default[validation].rule(component.state.value, _this.components)) {
	                    return validation;
	                } else {
	                    return null;
	                }
